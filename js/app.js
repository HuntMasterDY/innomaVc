 ...
 */
    ...
    (() => {
            ...
            menuIcon.forEach((el => {
                if (el) el.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-menu")) {
                        ...
                        if (block.closest(".body-header__menu")) {
                            bodyLockToggle();
                            block.classList.toggle("_active");
                            el.classList.toggle("_active");
                        }
                        document.addEventListener("keydown", (function(e) {
                            if (bodyLockStatus && "Escape" === e.key) {
                                document.documentElement.classList.remove("lock");
        ...
        function initSliders() {
            if (document.querySelector(".body-team__slider")) new core(".body-team__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".body-gallery__slider")) new core(".body-gallery__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
